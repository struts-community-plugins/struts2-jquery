...
g)}),a.oneisuccess&&(d=function(e){var f={};f.response=e;b.publishTopic(c,a.oneisuccess,f);return 400<=e.status?!1:!0}),a.oneierror&&(l=function(e,f){var g={};g.rowid=e;g.response=f;b.publishTopic(c,a.oneierror,g)}),a.oneisave&&(m=function(e,f){var g={};g.rowid=e;g.response=f;b.publishTopic(c,a.oneisave,g)}),c.jqGrid("editRow",f,!0,k,d,null,null,m,l,null))};a.oncesuccess&&(d.afterSaveCell=function(f,e,g,k,d){var l={};l.rowid=f;l.cellname=e;l.value=g;l.iRow=k;l.iCol=d;b.publishTopic(c,a.oncesuccess,
...
(d.loadtext=b.defaults.loadingText);d.loadComplete=b.pubCom(c,a.onalw,a.oncom,null,null,a);d.loadError=b.pubErr(c,a.onalw,a.onerr,a.errortext);a.grouping&&b.require("js/plugins/grid.grouping.js");a.editurl&&(b.require("js/plugins/grid.filter.js"),b.require("js/plugins/grid.formedit.js"),a.editinline&&b.require("js/plugins/grid.inlinedit.js"));a.cellurl&&b.require("js/plugins/grid.celledit.js");a.navigator&&b.require("js/plugins/grid.formedit.js");a.navigatorsearch&&b.require("js/plugins/grid.filter.js");
a.subgrid?(b.require("js/plugins/grid.subgrid.js"),d.subGrid=!0,d.gridview=!1,d.subGridRowExpanded=function(d,e){var g={},k=a.subgridoptions,m=d.replace(/(:|\.)/g,"\\$1")+"_table",l=h(b.escId(d)),r="\x3ctable id\x3d'"+m+"' class\x3d'scroll'\x3e\x3c/table\x3e",n=k.url.indexOf("?");g.proceed=!0;a.onsgrowexpanded&&(g.row_id=e,g.subgrid_id=d,b.publishTopic(c,a.onalw,g),b.publishTopic(c,a.onsgrowexpanded,g));e=escape(e);if(g.proceed){if(k.pager&&""!==k.pager||k.navigator)r=r+"\x3cdiv id\x3d'"+d.replace(/(:|\.)/g,
"\\$1")+"_pager'\x3e\x3c/div\x3e",k.pager=d.replace(/(:|\.)/g,"\\$1")+"_pager",k.navigatoraddoptions=h.extend(!0,k.navigatoraddoptions||{},{editData:{rowid:e}}),k.navigatoreditoptions=h.extend(!0,k.navigatoreditoptions||{},{editData:{rowid:e}}),k.navigatordeleteoptions=h.extend(!0,k.navigatordeleteoptions||{},{delData:{rowid:e}});h.each(k.colModel,function(a,c){c.editoptions&&c.editoptions.dataUrl&&(0<c.editoptions.dataUrl.indexOf("rowid")?c.editoptions.dataUrl=b.changeParam(c.editoptions.dataUrl,
"rowid",e):c.editoptions.dataUrl=b.addParam(c.editoptions.dataUrl,"rowid\x3d"+e));c.searchoptions&&c.searchoptions.dataUrl&&(0<c.searchoptions.dataUrl.indexOf("rowid")?c.searchoptions.dataUrl=b.changeParam(c.searchoptions.dataUrl,"rowid",e):c.searchoptions.dataUrl=b.addParam(c.searchoptions.dataUrl,"rowid\x3d"+e))});l.html(r);k.url&&(0<n&&(k.url=k.url.substring(0,n)),k.url=k.url+"?id\x3d"+e);l=h(b.escId(m));k=b.parseGridParams(l,k,k);l.jqGrid(k)}}):d.gridview=!0;if(a.url){var m="";a.formids&&(b.loadAtOnce||
b.require("js/plugins/jquery.form"+b.minSuffix+".js"),h.each(a.formids.split(","),function(a,c){var d=h(b.escId(c)).formSerialize();m=""!==m?m+"\x26"+d:d}));d.url=b.addParam(a.url,m)}return d},grid:function(c,a){var d={};this.log("grid for : "+a.id);this.require("i18n/grid.locale-"+this.gridLocal+".js",function(){h.jgrid.no_legacy_api=!0;h.jgrid.useJSON=!0});this.require("js/plugins/jquery.jqGrid"+this.minSuffix+".js");this.requireCss("themes/ui.jqgrid.css");if(a.sortable||a.sortableRows)this.loadAtOnce||
...
d.minSuffix+".js"),h.each(b.formids.split(","),function(a,b){var c=h(d.escId(b)).formSerialize();m=""!==m?m+"\x26"+c:c})),b.url=d.addParam(b.url,m)),f=h(d.escId(b.id)),f.jqGrid("setGridParam",{url:b.url}),d.log("reload grid "+b.id),f.trigger("reloadGrid"))})})(jQuery);