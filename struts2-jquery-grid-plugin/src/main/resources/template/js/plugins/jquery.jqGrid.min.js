...
'" class\x3d"cbox" name\x3d"jqg_'+b.p.id+"_"+a+'"'+(e?'checked\x3d"checked"':"")+"/\x3e";return'\x3ctd role\x3d"gridcell" '+q(c,d,"",null,a,!0)+"\x3e"+e+"\x3c/td\x3e"},y=function(a,b,c,d){c=(parseInt(c,10)-1)*parseInt(d,10)+1+b;return'\x3ctd role\x3d"gridcell" class\x3d"ui-state-default jqgrid-rownum" '+q(a,b,c,null,b,!0)+"\x3e"+c+"\x3c/td\x3e"},B=function(a){var c,d=[],e=0,f;for(f=0;f<b.p.colModel.length;f++)c=b.p.colModel[f],"cb"!==c.name&&"subgrid"!==c.name&&"rn"!==c.name&&(d[e]="local"===a?c.name:
"xml"===a||"xmlstring"===a?c.xmlmap||c.name:c.jsonmap||c.name,!1!==b.p.keyName&&!0===c.key&&(b.p.keyName=d[e]),e++);return d},z=function(c){var d=b.p.remapColumns;d&&d.length||(d=a.map(b.p.colModel,function(a,b){return b}));c&&(d=a.map(d,function(a){return a<c?null:a-c}));return d},N=function(b,c){var d;this.p.deepempty?a(this.rows).slice(1).remove():(d=0<this.rows.length?this.rows[0]:null,a(this.firstChild).empty().append(d));b&&this.p.scroll&&(a(this.grid.bDiv.firstChild).css({height:"auto"}),a(this.grid.bDiv.firstChild.firstChild).css({height:0,
display:"none"}),0!==this.grid.bDiv.scrollTop&&(this.grid.bDiv.scrollTop=0));!0===c&&this.p.treeGrid&&(this.p.data=[],this.p._index={})},w=function(){var c=b.p,d=c.data,e=d.length,f,g,k,h,l,m=c.localReader,n=c.colModel,p=m.cell,r=(!0===c.multiselect?1:0)+(!0===c.subGrid?1:0)+(!0===c.rownumbers?1:0),q=c.scroll?a.jgrid.randId():1,s,t,u;if("local"===c.datatype&&!0===m.repeatitems)for(s=z(r),t=B("local"),k=!1===c.keyIndex?a.isFunction(m.id)?m.id.call(b,d):m.id:c.keyIndex,c=0;c<e;c++){g=d[c];f=a.jgrid.getAccessor(g,
...
d),void 0===f&&(f=String(e+1)),b.p._index[f]=e},O=function(c,d,e,f,g,k){var h="-1",l="",m;d=d?"display:none;":"";e="ui-widget-content jqgrow ui-row-"+b.p.direction+(e?" "+e:"")+(k?" ui-state-highlight":"");k=a(b).triggerHandler("jqGridRowAttr",[f,g,c]);"object"!==typeof k&&(k=a.isFunction(b.p.rowattr)?b.p.rowattr.call(b,f,g,c):"string"===typeof b.p.rowattr&&null!=a.jgrid.rowattr&&a.isFunction(a.jgrid.rowattr[b.p.rowattr])?a.jgrid.rowattr[b.p.rowattr].call(b,f,g,c):{});if(!a.isEmptyObject(k)){k.hasOwnProperty("id")&&
(c=k.id,delete k.id);k.hasOwnProperty("tabindex")&&(h=k.tabindex,delete k.tabindex);k.hasOwnProperty("style")&&(d+=k.style,delete k.style);k.hasOwnProperty("class")&&(e+=" "+k["class"],delete k["class"]);try{delete k.role}catch(n){}for(m in k)k.hasOwnProperty(m)&&(l+=" "+m+"\x3d"+k[m])}return'\x3ctr role\x3d"row" id\x3d"'+c+'" tabindex\x3d"'+h+'" class\x3d"'+e+'"'+(""===d?"":' style\x3d"'+d+'"')+l+"\x3e"},X=function(c,d,e,f,g){var k=new Date,h="local"!==b.p.datatype&&b.p.loadonce||"xmlstring"===b.p.datatype,
l=b.p.xmlReader,m="local"===b.p.datatype?"local":"xml";h&&(b.p.data=[],b.p._index={},b.p.localReader.id="_id_");b.p.reccount=0;if(a.isXMLDoc(c)){-1!==b.p.treeANode||b.p.scroll?e=1<e?e:1:(N.call(b,!1,!0),e=1);var n=a(b),p,q,s=0,M,C=!0===b.p.multiselect?1:0,J=0,w,x=!0===b.p.rownumbers?1:0,$,A=[],v,G={},W,V,T=[],H=!0===b.p.altRows?b.p.altclass:"",R;!0===b.p.subGrid&&(J=1,w=a.jgrid.getMethod("addSubGridCell"));l.repeatitems||(A=B(m));$=!1===b.p.keyName?a.isFunction(l.id)?l.id.call(b,c):l.id:b.p.keyName;
m=-1===String($).indexOf("[")?A.length?function(b,c){return a($,b).text()||c}:function(b,c){return a(l.cell,b).eq($).text()||c}:function(a,b){return a.getAttribute($.replace(/[\[\]]/g,""))||b};b.p.userData={};b.p.page=r(a.jgrid.getXmlData(c,l.page),b.p.page);b.p.lastpage=r(a.jgrid.getXmlData(c,l.total),1);b.p.records=r(a.jgrid.getXmlData(c,l.records));a.isFunction(l.userdata)?b.p.userData=l.userdata.call(b,c)||{}:a.jgrid.getXmlData(c,l.userdata,!0).each(function(){b.p.userData[this.getAttribute("name")]=
a(this).text()});c=a.jgrid.getXmlData(c,l.root,!0);(c=a.jgrid.getXmlData(c,l.row,!0))||(c=[]);var I=c.length,E=0,D=[],Y=parseInt(b.p.rowNum,10),aa=b.p.scroll?a.jgrid.randId():1;0<I&&0>=b.p.page&&(b.p.page=1);if(c&&I){g&&(Y*=g+1);g=a.isFunction(b.p.afterInsertRow);var P=!1,F;b.p.grouping&&(P=!0===b.p.groupingView.groupCollapse,F=a.jgrid.getMethod("groupingPrepare"));for(;E<I;){W=c[E];V=m(W,aa+E);V=b.p.idPrefix+V;p=0===e?0:e+1;R=1===(p+E)%2?H:"";var L=T.length;T.push("");x&&T.push(y(0,E,b.p.page,b.p.rowNum));
C&&T.push(t(V,x,E,!1));J&&T.push(w.call(n,C+x,E+e));if(l.repeatitems){v||(v=z(C+J+x));var K=a.jgrid.getXmlData(W,l.cell,!0);a.each(v,function(a){var c=K[this];if(!c)return!1;M=c.textContent||c.text;G[b.p.colModel[a+C+J+x].name]=M;T.push(u(V,M,a+C+J+x,E+e,W,G))})}else for(p=0;p<A.length;p++)M=a.jgrid.getXmlData(W,A[p]),G[b.p.colModel[p+C+J+x].name]=M,T.push(u(V,M,p+C+J+x,E+e,W,G));T[L]=O(V,P,R,G,W,!1);T.push("\x3c/tr\x3e");b.p.grouping&&(D.push(T),b.p.groupingView._locgr||F.call(n,G,E),T=[]);if(h||
!0===b.p.treeGrid)G._id_=a.jgrid.stripPref(b.p.idPrefix,V),b.p.data.push(G),b.p._index[G._id_]=b.p.data.length-1;!1===b.p.gridview&&(a("tbody:first",d).append(T.join("")),n.triggerHandler("jqGridAfterInsertRow",[V,G,W]),g&&b.p.afterInsertRow.call(b,V,G,W),T=[]);G={};s++;E++;if(s===Y)break}}!0===b.p.gridview&&(q=-1<b.p.treeANode?b.p.treeANode:0,b.p.grouping?h||(n.jqGrid("groupingRender",D,b.p.colModel.length,b.p.page,Y),D=null):!0===b.p.treeGrid&&0<q?a(b.rows[q]).after(T.join("")):(b.firstElementChild.innerHTML+=
T.join(""),b.grid.cols=b.rows[0].cells));if(!0===b.p.subGrid)try{n.jqGrid("addSubGrid",C+x)}catch(Q){}b.p.totaltime=new Date-k;0<s&&0===b.p.records&&(b.p.records=I);T=null;if(!0===b.p.treeGrid)try{n.jqGrid("setTreeNode",q+1,s+q+1)}catch(S){}b.p.reccount=s;b.p.treeANode=-1;b.p.userDataOnFooter&&n.jqGrid("footerData","set",b.p.userData,!0);h&&(b.p.records=I,b.p.lastpage=Math.ceil(I/Y));f||b.updatepager(!1,!0);if(h){for(;s<I;){W=c[s];V=m(W,s+aa);V=b.p.idPrefix+V;if(l.repeatitems){v||(v=z(C+J+x));var ga=
a.jgrid.getXmlData(W,l.cell,!0);a.each(v,function(a){var c=ga[this];if(!c)return!1;M=c.textContent||c.text;G[b.p.colModel[a+C+J+x].name]=M})}else for(p=0;p<A.length;p++)M=a.jgrid.getXmlData(W,A[p]),G[b.p.colModel[p+C+J+x].name]=M;G._id_=a.jgrid.stripPref(b.p.idPrefix,V);b.p.grouping&&F.call(n,G,s);b.p.data.push(G);b.p._index[G._id_]=b.p.data.length-1;G={};s++}b.p.grouping&&(b.p.groupingView._locgr=!0,n.jqGrid("groupingRender",D,b.p.colModel.length,b.p.page,Y),D=null)}}},F=function(c,d,e,f,g){var k=
new Date;if(c){-1!==b.p.treeANode||b.p.scroll?e=1<e?e:1:(N.call(b,!1,!0),e=1);var h,l="local"!==b.p.datatype&&b.p.loadonce||"jsonstring"===b.p.datatype;l&&(b.p.data=[],b.p._index={},b.p.localReader.id="_id_");b.p.reccount=0;"local"===b.p.datatype?(d=b.p.localReader,h="local"):(d=b.p.jsonReader,h="json");var m=a(b),n=0,p,q,s,M=[],C,J=b.p.multiselect?1:0,x=!0===b.p.subGrid?1:0,w,E=!0===b.p.rownumbers?1:0,$=z(J+x+E);h=B(h);var A,G,v,I={},D,H,R=[],Y=!0===b.p.altRows?b.p.altclass:"",F;b.p.page=r(a.jgrid.getAccessor(c,
d.page),b.p.page);b.p.lastpage=r(a.jgrid.getAccessor(c,d.total),1);b.p.records=r(a.jgrid.getAccessor(c,d.records));b.p.userData=a.jgrid.getAccessor(c,d.userdata)||{};x&&(w=a.jgrid.getMethod("addSubGridCell"));v=!1===b.p.keyName?a.isFunction(d.id)?d.id.call(b,c):d.id:b.p.keyName;G=a.jgrid.getAccessor(c,d.root);null==G&&a.isArray(c)&&(G=c);G||(G=[]);c=G.length;q=0;0<c&&0>=b.p.page&&(b.p.page=1);var aa=parseInt(b.p.rowNum,10),P=b.p.scroll?a.jgrid.randId():1,L=!1,K;g&&(aa*=g+1);"local"!==b.p.datatype||
b.p.deselectAfterSort||(L=!0);var ga=a.isFunction(b.p.afterInsertRow);g=[];var Q=!1,S;b.p.grouping&&(Q=!0===b.p.groupingView.groupCollapse,S=a.jgrid.getMethod("groupingPrepare"));for(;q<c;){C=G[q];H=a.jgrid.getAccessor(C,v);void 0===H&&("number"===typeof v&&null!=b.p.colModel[v+J+x+E]&&(H=a.jgrid.getAccessor(C,b.p.colModel[v+J+x+E].name)),void 0===H&&(H=P+q,0===M.length&&d.cell&&(p=a.jgrid.getAccessor(C,d.cell)||C,H=null!=p&&void 0!==p[v]?p[v]:H)));H=b.p.idPrefix+H;p=1===e?0:e;F=1===(p+q)%2?Y:"";
L&&(K=b.p.multiselect?-1!==a.inArray(H,b.p.selarrrow):H===b.p.selrow);var U=R.length;R.push("");E&&R.push(y(0,q,b.p.page,b.p.rowNum));J&&R.push(t(H,E,q,K));x&&R.push(w.call(m,J+E,q+e));A=h;d.repeatitems&&(d.cell&&(C=a.jgrid.getAccessor(C,d.cell)||C),a.isArray(C)&&(A=$));for(s=0;s<A.length;s++)p=a.jgrid.getAccessor(C,A[s]),I[b.p.colModel[s+J+x+E].name]=p,R.push(u(H,p,s+J+x+E,q+e,C,I));R[U]=O(H,Q,F,I,C,K);R.push("\x3c/tr\x3e");b.p.grouping&&(g.push(R),b.p.groupingView._locgr||S.call(m,I,q),R=[]);if(l||
!0===b.p.treeGrid)I._id_=a.jgrid.stripPref(b.p.idPrefix,H),b.p.data.push(I),b.p._index[I._id_]=b.p.data.length-1;!1===b.p.gridview&&(a("#"+a.jgrid.jqID(b.p.id)+" tbody:first").append(R.join("")),m.triggerHandler("jqGridAfterInsertRow",[H,I,C]),ga&&b.p.afterInsertRow.call(b,H,I,C),R=[]);I={};n++;q++;if(n===aa)break}!0===b.p.gridview&&(D=-1<b.p.treeANode?b.p.treeANode:0,b.p.grouping?l||(m.jqGrid("groupingRender",g,b.p.colModel.length,b.p.page,aa),g=null):!0===b.p.treeGrid&&0<D?a(b.rows[D]).after(R.join("")):
(b.firstElementChild?b.firstElementChild.innerHTML+=R.join(""):(e=a(b.tBodies[0]),e.html(e.html()+R.join(""))),b.grid.cols=b.rows[0].cells));if(!0===b.p.subGrid)try{m.jqGrid("addSubGrid",J+E)}catch(ea){}b.p.totaltime=new Date-k;0<n&&0===b.p.records&&(b.p.records=c);if(!0===b.p.treeGrid)try{m.jqGrid("setTreeNode",D+1,n+D+1)}catch(da){}b.p.reccount=n;b.p.treeANode=-1;b.p.userDataOnFooter&&m.jqGrid("footerData","set",b.p.userData,!0);l&&(b.p.records=c,b.p.lastpage=Math.ceil(c/aa));f||b.updatepager(!1,
!0);if(l){for(;n<c&&G[n];){C=G[n];H=a.jgrid.getAccessor(C,v);void 0===H&&("number"===typeof v&&null!=b.p.colModel[v+J+x+E]&&(H=a.jgrid.getAccessor(C,b.p.colModel[v+J+x+E].name)),void 0===H&&(H=P+n,0===M.length&&d.cell&&(f=a.jgrid.getAccessor(C,d.cell)||C,H=null!=f&&void 0!==f[v]?f[v]:H)));if(C){H=b.p.idPrefix+H;A=h;d.repeatitems&&(d.cell&&(C=a.jgrid.getAccessor(C,d.cell)||C),a.isArray(C)&&(A=$));for(s=0;s<A.length;s++)I[b.p.colModel[s+J+x+E].name]=a.jgrid.getAccessor(C,A[s]);I._id_=a.jgrid.stripPref(b.p.idPrefix,
H);b.p.grouping&&S.call(m,I,n);b.p.data.push(I);b.p._index[I._id_]=b.p.data.length-1;I={}}n++}b.p.grouping&&(b.p.groupingView._locgr=!0,m.jqGrid("groupingRender",g,b.p.colModel.length,b.p.page,aa))}}},S=function(){function c(a){var b=0,d,e,f,k,h;if(null!=a.groups){(e=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&t.orBegin();for(d=0;d<a.groups.length;d++){0<b&&e&&t.or();try{c(a.groups[d])}catch(l){alert(l)}b++}e&&t.orEnd()}if(null!=a.rules)try{(f=a.rules.length&&"OR"===a.groupOp.toString().toUpperCase())&&
t.orBegin();for(d=0;d<a.rules.length;d++)h=a.rules[d],k=a.groupOp.toString().toUpperCase(),s[h.op]&&h.field&&(0<b&&k&&"OR"===k&&(t=t.or()),t=s[h.op](t,k)(h.field,h.data,g[h.field])),b++;f&&t.orEnd()}catch(m){alert(m)}}var d=b.p.multiSort?[]:"",e=[],f=!1,g={},k=[],h=[],l,m,n;if(a.isArray(b.p.data)){var p=b.p.grouping?b.p.groupingView:!1,q,r;a.each(b.p.colModel,function(){m=this.sorttype||"text";"date"===m||"datetime"===m?(this.formatter&&"string"===typeof this.formatter&&"date"===this.formatter?(l=
this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:a.jgrid.formatter.date.srcformat,n=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:a.jgrid.formatter.date.newformat):l=n=this.datefmt||"Y-m-d",g[this.name]={stype:m,srcfmt:l,newfmt:n,sfunc:this.sortfunc||null}):g[this.name]={stype:m,srcfmt:"",newfmt:"",sfunc:this.sortfunc||null};if(b.p.grouping)for(r=0,q=p.groupField.length;r<q;r++)if(this.name===p.groupField[r]){var c=this.name;this.index&&
(c=this.index);k[r]=g[c];h[r]=c}b.p.multiSort?this.lso&&(d.push(this.name),c=this.lso.split("-"),e.push(c[c.length-1])):f||this.index!==b.p.sortname&&this.name!==b.p.sortname||(d=this.name,f=!0)});if(b.p.treeGrid)a(b).jqGrid("SortTree",d,b.p.sortorder,g[d].stype||"text",g[d].srcfmt||"");else{var s={eq:function(a){return a.equals},ne:function(a){return a.notEquals},lt:function(a){return a.less},le:function(a){return a.lessOrEquals},gt:function(a){return a.greater},ge:function(a){return a.greaterOrEquals},
...
a.andNot().isNull}},t=a.jgrid.from(b.p.data);b.p.ignoreCase&&(t=t.ignoreCase());if(!0===b.p.search){var u=b.p.postData.filters;if(u)"string"===typeof u&&(u=a.jgrid.parse(u)),c(u);else try{t=s[b.p.postData.searchOper](t)(b.p.postData.searchField,b.p.postData.searchString,g[b.p.postData.searchField])}catch(y){}}if(b.p.grouping)for(r=0;r<q;r++)t.orderBy(h[r],p.groupOrder[r],k[r].stype,k[r].srcfmt);b.p.multiSort?a.each(d,function(a){t.orderBy(this,e[a],g[this].stype,g[this].srcfmt,g[this].sfunc)}):d&&
b.p.sortorder&&f&&("DESC"===b.p.sortorder.toUpperCase()?t.orderBy(b.p.sortname,"d",g[d].stype,g[d].srcfmt,g[d].sfunc):t.orderBy(b.p.sortname,"a",g[d].stype,g[d].srcfmt,g[d].sfunc));var u=t.select(),M=parseInt(b.p.rowNum,10),x=u.length,B=parseInt(b.p.page,10),I=Math.ceil(x/M),E={};if((b.p.search||b.p.resetsearch)&&b.p.grouping&&b.p.groupingView._locgr){b.p.groupingView.groups=[];var z,v=a.jgrid.getMethod("groupingPrepare"),w,A;if(b.p.footerrow&&b.p.userDataOnFooter){for(w in b.p.userData)b.p.userData.hasOwnProperty(w)&&
(b.p.userData[w]=0);A=!0}for(z=0;z<x;z++){if(A)for(w in b.p.userData)b.p.userData[w]+=parseFloat(u[z][w]||0);v.call(a(b),u[z],z,M)}}u=u.slice((B-1)*M,B*M);g=t=null;E[b.p.localReader.total]=I;E[b.p.localReader.page]=B;E[b.p.localReader.records]=x;E[b.p.localReader.root]=u;E[b.p.localReader.userdata]=b.p.userData;u=null;return E}}},v=function(){b.grid.hDiv.loading=!0;b.p.hiddengrid||a(b).jqGrid("progressBar",{method:"show",loadtype:b.p.loadui,htmlcontent:b.p.loadtext})},L=function(){b.grid.hDiv.loading=
!1;a(b).jqGrid("progressBar",{method:"hide",loadtype:b.p.loadui})},U=function(c){if(!b.grid.hDiv.loading){var d=b.p.scroll&&!1===c,e={},f,g=b.p.prmNames;0>=b.p.page&&(b.p.page=Math.min(1,b.p.lastpage));null!==g.search&&(e[g.search]=b.p.search);null!==g.nd&&(e[g.nd]=(new Date).getTime());null!==g.rows&&(e[g.rows]=b.p.rowNum);null!==g.page&&(e[g.page]=b.p.page);null!==g.sort&&(e[g.sort]=b.p.sortname);null!==g.order&&(e[g.order]=b.p.sortorder);null!==b.p.rowTotal&&null!==g.totalrows&&(e[g.totalrows]=
b.p.rowTotal);var k=a.isFunction(b.p.loadComplete),h=k?b.p.loadComplete:null,l=0;c=c||1;1<c?null!==g.npage?(e[g.npage]=c,l=c-1,c=1):h=function(a){b.p.page++;b.grid.hDiv.loading=!1;k&&b.p.loadComplete.call(b,a);U(c-1)}:null!==g.npage&&delete b.p.postData[g.npage];if(b.p.grouping){a(b).jqGrid("groupingSetup");var m=b.p.groupingView,n,p="";for(n=0;n<m.groupField.length;n++){var r=m.groupField[n];a.each(b.p.colModel,function(a,b){b.name===r&&b.index&&(r=b.index)});p+=r+" "+m.groupOrder[n]+", "}e[g.sort]=
p+e[g.sort]}a.extend(b.p.postData,e);var q=b.p.scroll?b.rows.length-1:1,e=a(b).triggerHandler("jqGridBeforeRequest");if(!1!==e&&"stop"!==e)if(a.isFunction(b.p.datatype))b.p.datatype.call(b,b.p.postData,"load_"+b.p.id,q,c,l);else{if(a.isFunction(b.p.beforeRequest)&&(e=b.p.beforeRequest.call(b),void 0===e&&(e=!0),!1===e))return;f=b.p.datatype.toLowerCase();switch(f){case "json":case "jsonp":case "xml":case "script":a.ajax(a.extend({url:b.p.url,type:b.p.mtype,dataType:f,data:a.isFunction(b.p.serializeGridData)?
b.p.serializeGridData.call(b,b.p.postData):b.p.postData,success:function(e,g,k){if(a.isFunction(b.p.beforeProcessing)&&!1===b.p.beforeProcessing.call(b,e,g,k))L();else{"xml"===f?X(e,b.grid.bDiv,q,1<c,l):F(e,b.grid.bDiv,q,1<c,l);a(b).triggerHandler("jqGridLoadComplete",[e]);h&&h.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",[e]);d&&b.grid.populateVisible();if(b.p.loadonce||b.p.treeGrid)b.p.datatype="local";1===c&&L()}},error:function(d,e,f){a.isFunction(b.p.loadError)&&b.p.loadError.call(b,
d,e,f);1===c&&L()},beforeSend:function(c,d){var e=!0;a.isFunction(b.p.loadBeforeSend)&&(e=b.p.loadBeforeSend.call(b,c,d));void 0===e&&(e=!0);if(!1===e)return!1;v()}},a.jgrid.ajaxOptions,b.p.ajaxGridOptions));break;case "xmlstring":v();e="string"!==typeof b.p.datastr?b.p.datastr:a.parseXML(b.p.datastr);X(e,b.grid.bDiv);a(b).triggerHandler("jqGridLoadComplete",[e]);k&&b.p.loadComplete.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",[e]);b.p.datatype="local";b.p.datastr=null;L();break;case "jsonstring":v();
e="string"===typeof b.p.datastr?a.jgrid.parse(b.p.datastr):b.p.datastr;F(e,b.grid.bDiv);a(b).triggerHandler("jqGridLoadComplete",[e]);k&&b.p.loadComplete.call(b,e);a(b).triggerHandler("jqGridAfterLoadComplete",[e]);b.p.datatype="local";b.p.datastr=null;L();break;case "local":case "clientside":v(),b.p.datatype="local",e=S(),F(e,b.grid.bDiv,q,1<c,l),a(b).triggerHandler("jqGridLoadComplete",[e]),h&&h.call(b,e),a(b).triggerHandler("jqGridAfterLoadComplete",[e]),d&&b.grid.populateVisible(),L()}}}},ca=
function(c){a("#cb_"+a.jgrid.jqID(b.p.id),b.grid.hDiv)[b.p.useProp?"prop":"attr"]("checked",c);if(b.p.frozenColumns&&b.p.id+"_frozen")a("#cb_"+a.jgrid.jqID(b.p.id),b.grid.fhDiv)[b.p.useProp?"prop":"attr"]("checked",c)},ka=function(c,d){var e="",f="\x3ctable cellspacing\x3d'0' cellpadding\x3d'0' border\x3d'0' style\x3d'table-layout:auto;' class\x3d'ui-pg-table'\x3e\x3ctbody\x3e\x3ctr\x3e",g="",k,h,m,n,p=function(c){var d;a.isFunction(b.p.onPaging)&&(d=b.p.onPaging.call(b,c));if("stop"===d)return!1;
b.p.selrow=null;b.p.multiselect&&(b.p.selarrrow=[],ca(!1));b.p.savedRow=[];return!0};c=c.substr(1);d+="_"+c;k="pg_"+c;h=c+"_left";m=c+"_center";n=c+"_right";a("#"+a.jgrid.jqID(c)).append("\x3cdiv id\x3d'"+k+"' class\x3d'ui-pager-control' role\x3d'group'\x3e\x3ctable cellspacing\x3d'0' cellpadding\x3d'0' border\x3d'0' class\x3d'ui-pg-table' style\x3d'width:100%;table-layout:fixed;height:100%;' role\x3d'row'\x3e\x3ctbody\x3e\x3ctr\x3e\x3ctd id\x3d'"+h+"' align\x3d'left'\x3e\x3c/td\x3e\x3ctd id\x3d'"+
m+"' align\x3d'center' style\x3d'white-space:pre;'\x3e\x3c/td\x3e\x3ctd id\x3d'"+n+"' align\x3d'right'\x3e\x3c/td\x3e\x3c/tr\x3e\x3c/tbody\x3e\x3c/table\x3e\x3c/div\x3e").attr("dir","ltr");if(0<b.p.rowList.length){g="\x3ctd dir\x3d'"+l+"'\x3e";g+="\x3cselect class\x3d'ui-pg-selbox' role\x3d'listbox' "+(b.p.pgrecs?"title\x3d'"+b.p.pgrecs+"'":"")+"\x3e";for(h=0;h<b.p.rowList.length;h++)m=b.p.rowList[h].toString().split(":"),1===m.length&&(m[1]=m[0]),g+='\x3coption role\x3d"option" value\x3d"'+m[0]+
'"'+(r(b.p.rowNum,0)===r(m[0],0)?' selected\x3d"selected"':"")+"\x3e"+m[1]+"\x3c/option\x3e";g+="\x3c/select\x3e\x3c/td\x3e"}"rtl"===l&&(f+=g);!0===b.p.pginput&&(e="\x3ctd dir\x3d'"+l+"'\x3e"+a.jgrid.format(b.p.pgtext||"","\x3cinput class\x3d'ui-pg-input' type\x3d'text' size\x3d'2' maxlength\x3d'7' value\x3d'0' role\x3d'textbox'/\x3e","\x3cspan id\x3d'sp_1_"+a.jgrid.jqID(c)+"'\x3e\x3c/span\x3e")+"\x3c/td\x3e");!0===b.p.pgbuttons?(h=["first"+d,"prev"+d,"next"+d,"last"+d],"rtl"===l&&h.reverse(),f+=
"\x3ctd id\x3d'"+h[0]+"' class\x3d'ui-pg-button ui-corner-all' "+(b.p.pgfirst?"title\x3d'"+b.p.pgfirst+"'":"")+"\x3e\x3cspan class\x3d'ui-icon ui-icon-seek-first'\x3e\x3c/span\x3e\x3c/td\x3e",f+="\x3ctd id\x3d'"+h[1]+"' class\x3d'ui-pg-button ui-corner-all' "+(b.p.pgprev?"title\x3d'"+b.p.pgprev+"'":"")+"\x3e\x3cspan class\x3d'ui-icon ui-icon-seek-prev'\x3e\x3c/span\x3e\x3c/td\x3e",f=f+(""!==e?"\x3ctd class\x3d'ui-pg-button ui-state-disabled' style\x3d'width:4px;'\x3e\x3cspan class\x3d'ui-separator'\x3e\x3c/span\x3e\x3c/td\x3e"+
e+"\x3ctd class\x3d'ui-pg-button ui-state-disabled' style\x3d'width:4px;'\x3e\x3cspan class\x3d'ui-separator'\x3e\x3c/span\x3e\x3c/td\x3e":"")+("\x3ctd id\x3d'"+h[2]+"' class\x3d'ui-pg-button ui-corner-all' "+(b.p.pgnext?"title\x3d'"+b.p.pgnext+"'":"")+"\x3e\x3cspan class\x3d'ui-icon ui-icon-seek-next'\x3e\x3c/span\x3e\x3c/td\x3e"),f+="\x3ctd id\x3d'"+h[3]+"' class\x3d'ui-pg-button ui-corner-all' "+(b.p.pglast?"title\x3d'"+b.p.pglast+"'":"")+"\x3e\x3cspan class\x3d'ui-icon ui-icon-seek-end'\x3e\x3c/span\x3e\x3c/td\x3e"):
""!==e&&(f+=e);"ltr"===l&&(f+=g);f+="\x3c/tr\x3e\x3c/tbody\x3e\x3c/table\x3e";!0===b.p.viewrecords&&a("td#"+c+"_"+b.p.recordpos,"#"+k).append("\x3cdiv dir\x3d'"+l+"' style\x3d'text-align:"+b.p.recordpos+"' class\x3d'ui-paging-info'\x3e\x3c/div\x3e");a("td#"+c+"_"+b.p.pagerpos,"#"+k).append(f);g=a(".ui-jqgrid").css("font-size")||"11px";a(document.body).append("\x3cdiv id\x3d'testpg' class\x3d'ui-jqgrid ui-widget ui-widget-content' style\x3d'font-size:"+g+";visibility:hidden;' \x3e\x3c/div\x3e");f=
a(f).clone().appendTo("#testpg").width();a("#testpg").remove();0<f&&(""!==e&&(f+=50),a("td#"+c+"_"+b.p.pagerpos,"#"+k).width(f));b.p._nvtd=[];b.p._nvtd[0]=f?Math.floor((b.p.width-f)/2):Math.floor(b.p.width/3);b.p._nvtd[1]=0;f=null;a(".ui-pg-selbox","#"+k).bind("change",function(){if(!p("records"))return!1;b.p.page=Math.round(b.p.rowNum*(b.p.page-1)/this.value-.5)+1;b.p.rowNum=this.value;b.p.pager&&a(".ui-pg-selbox",b.p.pager).val(this.value);b.p.toppager&&a(".ui-pg-selbox",b.p.toppager).val(this.value);
U();return!1});!0===b.p.pgbuttons&&(a(".ui-pg-button","#"+k).hover(function(){a(this).hasClass("ui-state-disabled")?this.style.cursor="default":(a(this).addClass("ui-state-hover"),this.style.cursor="pointer")},function(){a(this).hasClass("ui-state-disabled")||(a(this).removeClass("ui-state-hover"),this.style.cursor="default")}),a("#first"+a.jgrid.jqID(d)+", #prev"+a.jgrid.jqID(d)+", #next"+a.jgrid.jqID(d)+", #last"+a.jgrid.jqID(d)).click(function(){if(a(this).hasClass("ui-state-disabled"))return!1;
var c=r(b.p.page,1),e=r(b.p.lastpage,1),f=!1,g=!0,k=!0,h=!0,l=!0;0===e||1===e?l=h=k=g=!1:1<e&&1<=c?1===c?k=g=!1:c===e&&(l=h=!1):1<e&&0===c&&(l=h=!1,c=e-1);if(!p(this.id))return!1;this.id==="first"+d&&g&&(b.p.page=1,f=!0);this.id==="prev"+d&&k&&(b.p.page=c-1,f=!0);this.id==="next"+d&&h&&(b.p.page=c+1,f=!0);this.id==="last"+d&&l&&(b.p.page=e,f=!0);f&&U();return!1}));!0===b.p.pginput&&a("input.ui-pg-input","#"+k).keypress(function(c){if(13===(c.charCode||c.keyCode||0)){if(!p("user"))return!1;a(this).val(r(a(this).val(),
1));b.p.page=0<a(this).val()?a(this).val():b.p.page;U();return!1}return this})},M=function(c,d){var e,f="",g=b.p.colModel,k=!1,h;h=b.p.frozenColumns?d:b.grid.headers[c].el;var l="";a("span.ui-grid-ico-sort",h).addClass("ui-state-disabled");a(h).attr("aria-selected","false");if(g[c].lso)if("asc"===g[c].lso)g[c].lso+="-desc",l="desc";else if("desc"===g[c].lso)g[c].lso+="-asc",l="asc";else{if("asc-desc"===g[c].lso||"desc-asc"===g[c].lso)g[c].lso=""}else g[c].lso=l=g[c].firstsortorder||"asc";l?(a("span.s-ico",
h).show(),a("span.ui-icon-"+l,h).removeClass("ui-state-disabled"),a(h).attr("aria-selected","true")):b.p.viewsortcols[0]||a("span.s-ico",h).hide();b.p.sortorder="";a.each(g,function(a){this.lso&&(0<a&&k&&(f+=", "),e=this.lso.split("-"),f+=g[a].index||g[a].name,f+=" "+e[e.length-1],k=!0,b.p.sortorder=e[e.length-1])});h=f.lastIndexOf(b.p.sortorder);f=f.substring(0,h);b.p.sortname=f},Y=function(c,d,e,f,g){if(b.p.colModel[d].sortable&&!(0<b.p.savedRow.length)){e||(b.p.lastsort===d&&""!==b.p.sortname?
"asc"===b.p.sortorder?b.p.sortorder="desc":"desc"===b.p.sortorder&&(b.p.sortorder="asc"):b.p.sortorder=b.p.colModel[d].firstsortorder||"asc",b.p.page=1);if(b.p.multiSort)M(d,g);else{if(f){if(b.p.lastsort===d&&b.p.sortorder===f&&!e)return;b.p.sortorder=f}e=b.grid.headers[b.p.lastsort].el;g=b.p.frozenColumns?g:b.grid.headers[d].el;a("span.ui-grid-ico-sort",e).addClass("ui-state-disabled");a(e).attr("aria-selected","false");b.p.frozenColumns&&(b.grid.fhDiv.find("span.ui-grid-ico-sort").addClass("ui-state-disabled"),
b.grid.fhDiv.find("th").attr("aria-selected","false"));a("span.ui-icon-"+b.p.sortorder,g).removeClass("ui-state-disabled");a(g).attr("aria-selected","true");b.p.viewsortcols[0]||(b.p.lastsort!==d?(b.p.frozenColumns&&b.grid.fhDiv.find("span.s-ico").hide(),a("span.s-ico",e).hide(),a("span.s-ico",g).show()):""===b.p.sortname&&a("span.s-ico",g).show());c=c.substring(5+b.p.id.length+1);b.p.sortname=b.p.colModel[d].index||c}"stop"===a(b).triggerHandler("jqGridSortCol",[b.p.sortname,d,b.p.sortorder])?b.p.lastsort=
d:a.isFunction(b.p.onSortCol)&&"stop"===b.p.onSortCol.call(b,b.p.sortname,d,b.p.sortorder)?b.p.lastsort=d:("local"===b.p.datatype?b.p.deselectAfterSort&&a(b).jqGrid("resetSelection"):(b.p.selrow=null,b.p.multiselect&&ca(!1),b.p.selarrrow=[],b.p.savedRow=[]),b.p.scroll&&(g=b.grid.bDiv.scrollLeft,N.call(b,!0,!1),b.grid.hDiv.scrollLeft=g),b.p.subGrid&&"local"===b.p.datatype&&a("td.sgexpanded","#"+a.jgrid.jqID(b.p.id)).each(function(){a(this).trigger("click")}),U(),b.p.lastsort=d,b.p.sortname!==c&&d&&
(b.p.lastsort=d))}},$=function(c){c=a(b.grid.headers[c].el);c=[c.position().left+c.outerWidth()];"rtl"===b.p.direction&&(c[0]=b.p.width-c[0]);c[0]-=b.grid.bDiv.scrollLeft;c.push(a(b.grid.hDiv).position().top);c.push(a(b.grid.bDiv).offset().top-a(b.grid.hDiv).offset().top+a(b.grid.bDiv).height());return c},I=function(c){var d,e=b.grid.headers,f=a.jgrid.getCellIndex(c);for(d=0;d<e.length;d++)if(c===e[d].el){f=d;break}return f},x;this.p.id=this.id;-1===a.inArray(b.p.multikey,["shiftKey","altKey","ctrlKey"])&&
(b.p.multikey=!1);b.p.keyName=!1;for(k=0;k<b.p.colModel.length;k++)x="string"===typeof b.p.colModel[k].template?null!=a.jgrid.cmTemplate&&"object"===typeof a.jgrid.cmTemplate[b.p.colModel[k].template]?a.jgrid.cmTemplate[b.p.colModel[k].template]:{}:b.p.colModel[k].template,b.p.colModel[k]=a.extend(!0,{},b.p.cmTemplate,x||{},b.p.colModel[k]),!1===b.p.keyName&&!0===b.p.colModel[k].key&&(b.p.keyName=b.p.colModel[k].name);b.p.sortorder=b.p.sortorder.toLowerCase();a.jgrid.cell_width=a.jgrid.cellWidth();
!0===b.p.grouping&&(b.p.scroll=!1,b.p.rownumbers=!1,b.p.treeGrid=!1,b.p.gridview=!0);if(!0===this.p.treeGrid){try{a(this).jqGrid("setTreeGrid")}catch(E){}"local"!==b.p.datatype&&(b.p.localReader={id:"_id_"})}if(this.p.subGrid)try{a(b).jqGrid("setSubGrid")}catch(aa){}this.p.multiselect&&(this.p.colNames.unshift("\x3cinput role\x3d'checkbox' id\x3d'cb_"+this.p.id+"' class\x3d'cbox' type\x3d'checkbox'/\x3e"),this.p.colModel.unshift({name:"cb",width:a.jgrid.cell_width?b.p.multiselectWidth+b.p.cellLayout:
b.p.multiselectWidth,sortable:!1,resizable:!1,hidedlg:!0,search:!1,align:"center",fixed:!0}));this.p.rownumbers&&(this.p.colNames.unshift(""),this.p.colModel.unshift({name:"rn",width:b.p.rownumWidth,sortable:!1,resizable:!1,hidedlg:!0,search:!1,align:"center",fixed:!0}));b.p.xmlReader=a.extend(!0,{root:"rows",row:"row",page:"rows\x3epage",total:"rows\x3etotal",records:"rows\x3erecords",repeatitems:!0,cell:"cell",id:"[id]",userdata:"userdata",subgrid:{root:"rows",row:"row",repeatitems:!0,cell:"cell"}},
...
(w(),Q());x="\x3cthead\x3e\x3ctr class\x3d'ui-jqgrid-labels' role\x3d'row'\x3e";var qa,P,la,ia,ma,A,D,fa,ra=fa="",ja=[],ga=[];P=[];if(!0===b.p.shrinkToFit&&!0===b.p.forceFit)for(k=b.p.colModel.length-1;0<=k;k--)if(!b.p.colModel[k].hidden){b.p.colModel[k].resizable=!1;break}"horizontal"===b.p.viewsortcols[1]&&(fa=" ui-i-asc",ra=" ui-i-desc");qa=c?"class\x3d'ui-th-div-ie'":"";fa="\x3cspan class\x3d's-ico' style\x3d'display:none'\x3e\x3cspan sort\x3d'asc' class\x3d'ui-grid-ico-sort ui-icon-asc"+fa+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+
l+"'\x3e\x3c/span\x3e"+("\x3cspan sort\x3d'desc' class\x3d'ui-grid-ico-sort ui-icon-desc"+ra+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+l+"'\x3e\x3c/span\x3e\x3c/span\x3e");if(b.p.multiSort)for(ja=b.p.sortname.split(","),k=0;k<ja.length;k++)P=a.trim(ja[k]).split(" "),ja[k]=a.trim(P[0]),ga[k]=P[1]?a.trim(P[1]):b.p.sortorder||"asc";for(k=0;k<this.p.colNames.length;k++)P=b.p.headertitles?' title\x3d"'+a.jgrid.stripHtml(b.p.colNames[k])+'"':"",x+="\x3cth id\x3d'"+b.p.id+"_"+b.p.colModel[k].name+
"' role\x3d'columnheader' class\x3d'ui-state-default ui-th-column ui-th-"+l+"'"+P+"\x3e",P=b.p.colModel[k].index||b.p.colModel[k].name,x+="\x3cdiv id\x3d'jqgh_"+b.p.id+"_"+b.p.colModel[k].name+"' "+qa+"\x3e"+b.p.colNames[k],b.p.colModel[k].width=b.p.colModel[k].width?parseInt(b.p.colModel[k].width,10):150,"boolean"!==typeof b.p.colModel[k].title&&(b.p.colModel[k].title=!0),b.p.colModel[k].lso="",P===b.p.sortname&&(b.p.lastsort=k),b.p.multiSort&&(P=a.inArray(P,ja),-1!==P&&(b.p.colModel[k].lso=ga[P])),
x+=fa+"\x3c/div\x3e\x3c/th\x3e";x+="\x3c/tr\x3e\x3c/thead\x3e";fa=null;a(this).append(x);a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});if(this.p.multiselect){var na=[],ea;a("#cb_"+a.jgrid.jqID(b.p.id),this).bind("click",function(){b.p.selarrrow=[];var c=!0===b.p.frozenColumns?b.p.id+"_frozen":"";this.checked?(a(b.rows).each(function(d){0<d&&!(a(this).hasClass("ui-subgrid")||a(this).hasClass("jqgroup")||a(this).hasClass("ui-state-disabled")||
a(this).hasClass("jqfoot"))&&(a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id))[b.p.useProp?"prop":"attr"]("checked",!0),a(this).addClass("ui-state-highlight").attr("aria-selected","true"),b.p.selarrrow.push(this.id),b.p.selrow=this.id,c&&(a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id),b.grid.fbDiv)[b.p.useProp?"prop":"attr"]("checked",!0),a("#"+a.jgrid.jqID(this.id),b.grid.fbDiv).addClass("ui-state-highlight")))}),ea=!0,na=[]):(a(b.rows).each(function(d){0<d&&!(a(this).hasClass("ui-subgrid")||
a(this).hasClass("jqgroup")||a(this).hasClass("ui-state-disabled")||a(this).hasClass("jqfoot"))&&(a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id))[b.p.useProp?"prop":"attr"]("checked",!1),a(this).removeClass("ui-state-highlight").attr("aria-selected","false"),na.push(this.id),c&&(a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id),b.grid.fbDiv)[b.p.useProp?"prop":"attr"]("checked",!1),a("#"+a.jgrid.jqID(this.id),b.grid.fbDiv).removeClass("ui-state-highlight")))}),b.p.selrow=null,ea=
!1);a(b).triggerHandler("jqGridSelectAll",[ea?b.p.selarrrow:na,ea]);a.isFunction(b.p.onSelectAll)&&b.p.onSelectAll.call(b,ea?b.p.selarrrow:na,ea)})}!0===b.p.autowidth&&(x=a(n).innerWidth(),b.p.width=0<x?x:"nw");(function(){var c=0,d=a.jgrid.cell_width?0:r(b.p.cellLayout,0),e=0,f,k=r(b.p.scrollOffset,0),h,l=!1,m,n=0,p;a.each(b.p.colModel,function(){void 0===this.hidden&&(this.hidden=!1);if(b.p.grouping&&b.p.autowidth){var f=a.inArray(this.name,b.p.groupingView.groupField);0<=f&&b.p.groupingView.groupColumnShow.length>
...
a("div span.ui-icon-"+b.p.sortorder,this).removeClass("ui-state-disabled")):c===b.p.lastsort&&""!==b.p.sortname&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+b.p.sortorder,this).removeClass("ui-state-disabled")));b.p.footerrow&&(da+="\x3ctd role\x3d'gridcell' "+q(c,0,"",null,"",!1)+"\x3e\x26#160;\x3c/td\x3e")}).mousedown(function(c){if(1===a(c.target).closest("th\x3espan.ui-jqgrid-resize").length){var d=I(this);if(!0===b.p.forceFit){var e=b.p,f=d,k;for(k=d+1;k<b.p.colModel.length;k++)if(!0!==
b.p.colModel[k].hidden){f=k;break}e.nv=f-d}g.dragStart(d,c,$(d));return!1}}).click(function(c){if(b.p.disableClick)return b.p.disableClick=!1;var d="th\x3ediv.ui-jqgrid-sortable",e,f;b.p.viewsortcols[2]||(d="th\x3ediv\x3espan\x3espan.ui-grid-ico-sort");c=a(c.target).closest(d);if(1===c.length){var g;if(b.p.frozenColumns){var k=a(this)[0].id.substring(b.p.id.length+1);a(b.p.colModel).each(function(a){if(this.name===k)return g=a,!1})}else g=I(this);b.p.viewsortcols[2]||(e=!0,f=c.attr("sort"));null!=
g&&Y(a("div",this)[0].id,g,e,f,this);return!1}});if(b.p.sortable&&a.fn.sortable)try{a(b).jqGrid("sortableColumns",m)}catch(ta){}b.p.footerrow&&(da+="\x3c/tr\x3e\x3c/tbody\x3e\x3c/table\x3e");ha+="\x3c/tr\x3e";m=document.createElement("tbody");this.appendChild(m);a(this).addClass("ui-jqgrid-btable").append(ha);var ha=null,m=a("\x3ctable class\x3d'ui-jqgrid-htable' style\x3d'width:"+b.p.tblwidth+"px' role\x3d'presentation' aria-labelledby\x3d'gbox_"+this.id+"' cellspacing\x3d'0' cellpadding\x3d'0' border\x3d'0'\x3e\x3c/table\x3e").append(x),
Z=b.p.caption&&!0===b.p.hiddengrid?!0:!1;k=a("\x3cdiv class\x3d'ui-jqgrid-hbox"+("rtl"===l?"-rtl":"")+"'\x3e\x3c/div\x3e");x=null;g.hDiv=document.createElement("div");a(g.hDiv).css({width:g.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(k);a(k).append(m);m=null;Z&&a(g.hDiv).hide();b.p.pager&&("string"===typeof b.p.pager?"#"!==b.p.pager.substr(0,1)&&(b.p.pager="#"+b.p.pager):b.p.pager="#"+a(b.p.pager).attr("id"),a(b.p.pager).css({width:g.width+"px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(n),
Z&&a(b.p.pager).hide(),ka(b.p.pager,""));!1===b.p.cellEdit&&!0===b.p.hoverrows&&a(b).bind("mouseover",function(b){D=a(b.target).closest("tr.jqgrow");"ui-subgrid"!==a(D).attr("class")&&a(D).addClass("ui-state-hover")}).bind("mouseout",function(b){D=a(b.target).closest("tr.jqgrow");a(D).removeClass("ui-state-hover")});var K,ba,oa;a(b).before(g.hDiv).click(function(c){A=c.target;D=a(A,b.rows).closest("tr.jqgrow");if(0===a(D).length||-1<D[0].className.indexOf("ui-state-disabled")||(a(A,b).closest("table.ui-jqgrid-btable").attr("id")||
"").replace("_frozen","")!==b.id)return this;var d=a(A).hasClass("cbox"),e=a(b).triggerHandler("jqGridBeforeSelectRow",[D[0].id,c]),e=!1===e||"stop"===e?!1:!0;if(a.isFunction(b.p.beforeSelectRow)){var f=b.p.beforeSelectRow.call(b,D[0].id,c);if(!1===f||"stop"===f)e=!1}if("A"!==A.tagName&&("INPUT"!==A.tagName&&"TEXTAREA"!==A.tagName&&"OPTION"!==A.tagName&&"SELECT"!==A.tagName||d)){K=D[0].id;A=a(A).closest("tr.jqgrow\x3etd");0<A.length&&(ba=a.jgrid.getCellIndex(A),oa=a(A).closest("td,th").html(),a(b).triggerHandler("jqGridCellSelect",
[K,ba,oa,c]),a.isFunction(b.p.onCellSelect)&&b.p.onCellSelect.call(b,K,ba,oa,c));if(!0===b.p.cellEdit)if(b.p.multiselect&&d&&e)a(b).jqGrid("setSelection",K,!0,c);else if(0<A.length){K=D[0].rowIndex;try{a(b).jqGrid("editCell",K,ba,!0)}catch(g){}}if(e)if(b.p.multikey)c[b.p.multikey]?a(b).jqGrid("setSelection",K,!0,c):b.p.multiselect&&d&&(d=a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+K).is(":checked"),a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+K)[b.p.useProp?"prop":"attr"]("checked",d));else{if(b.p.multiselect&&b.p.multiboxonly&&
...
c)}}}).bind("reloadGrid",function(c,d){!0===b.p.treeGrid&&(b.p.datatype=b.p.treedatatype);d&&d.current&&b.grid.selectionPreserver(b);"local"===b.p.datatype?(a(b).jqGrid("resetSelection"),b.p.data.length&&(w(),Q())):b.p.treeGrid||(b.p.selrow=null,b.p.multiselect&&(b.p.selarrrow=[],ca(!1)),b.p.savedRow=[]);b.p.scroll&&N.call(b,!0,!1);if(d&&d.page){var e=d.page;e>b.p.lastpage&&(e=b.p.lastpage);1>e&&(e=1);b.p.page=e;b.grid.bDiv.scrollTop=b.grid.prevRowHeight?(e-1)*b.grid.prevRowHeight*b.p.rowNum:0}b.grid.prevRowHeight&&
...
(b=l.buildSelect(b))&&a("td:eq(1)",s).append(b):a("td:eq(1)",s).append(b);void 0!==l.defaultValue&&a("select",p).val(l.defaultValue);a("select",p).attr({name:k.index||k.name,id:"gs_"+k.name});l.attr&&a("select",p).attr(l.attr);a("select",p).css({width:"100%"});a.jgrid.bindEv.call(c,a("select",p)[0],l);!0===d.autosearch&&a("select",p).change(function(){e();return!1});b=null}},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||{}));else{var u,t,y;k.searchoptions?(u=void 0===k.searchoptions.value?"":k.searchoptions.value,
t=void 0===k.searchoptions.separator?":":k.searchoptions.separator,y=void 0===k.searchoptions.delimiter?";":k.searchoptions.delimiter):k.editoptions&&(u=void 0===k.editoptions.value?"":k.editoptions.value,t=void 0===k.editoptions.separator?":":k.editoptions.separator,y=void 0===k.editoptions.delimiter?";":k.editoptions.delimiter);if(u){var B=document.createElement("select");B.style.width="100%";a(B).attr({name:k.index||k.name,id:"gs_"+k.name});var z;if("string"===typeof u)for(m=u.split(y),z=0;z<m.length;z++)u=
m[z].split(t),y=document.createElement("option"),y.value=u[0],y.innerHTML=u[1],B.appendChild(y);else if("object"===typeof u)for(z in u)u.hasOwnProperty(z)&&(y=document.createElement("option"),y.value=z,y.innerHTML=u[z],B.appendChild(y));void 0!==l.defaultValue&&a(B).val(l.defaultValue);l.attr&&a(B).attr(l.attr);a(p).append(s);a.jgrid.bindEv.call(c,B,l);a("td:eq(1)",s).append(B);!0===d.autosearch&&a(B).change(function(){e();return!1})}}break;case "text":t=void 0!==l.defaultValue?l.defaultValue:"";
...
default:b&&clearTimeout(b),b=setTimeout(function(){e()},d.autosearchDelay)}}));break;case "custom":a("td:eq(1)",s).append("\x3cspan style\x3d'width:95%;padding:0px;' name\x3d'"+(k.index||k.name)+"' id\x3d'gs_"+k.name+"'/\x3e");a(p).append(s);try{if(a.isFunction(l.custom_element))if(B=l.custom_element.call(c,void 0!==l.defaultValue?l.defaultValue:"",l))B=a(B).addClass("customelement"),a(p).find("span[name\x3d'"+(k.index||k.name)+"']").append(B);else throw"e2";else throw"e1";}catch(N){"e1"===N&&a.jgrid.info_dialog(a.jgrid.errors.errcap,
"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===N?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof N?N:N.message,a.jgrid.edit.bClose)}}}a(q).append(p);a(h).append(q);d.searchOperators||a("td:eq(0)",s).hide()});a("table thead",c.grid.hDiv).append(h);d.searchOperators&&(a(".soptclass",h).click(function(b){var c=a(this).offset();f(this,c.left,
...
p+s:p+s+"_"+d[k].aggregator+"_"+String(k)}catch(t){}}var u=l=isNaN(parseInt(l,10))?l:l+" ",v=r,z=l,w=f[l],y=d[k].member,B=c,F=void 0;switch(d[k].aggregator){case "sum":F=parseFloat(w||0)+parseFloat(B[y]||0);break;case "count":if(""===w||null==w)w=0;F=B.hasOwnProperty(y)?w+1:0;break;case "min":F=""===w||null==w?parseFloat(B[y]||0):Math.min(parseFloat(w),parseFloat(B[y]||0));break;case "max":F=""===w||null==w?parseFloat(B[y]||0):Math.max(parseFloat(w),parseFloat(B[y]||0))}f[u]=v[z]=F;1>=m&&"_r_Totals"!==
s&&""===p&&(p=s)}b[l]=r;g[l]=q[m]}return f}function p(a){var b,c,d,f,g;for(d in a)if(a.hasOwnProperty(d)){if("object"!==typeof a[d]){if("level"===d){void 0===U[a.level]&&(U[a.level]="",0<a.level&&"_r_Totals"!==a.text&&(l[a.level-1]={useColSpanStyle:!1,groupHeaders:[]}));if(U[a.level]!==a.text&&a.children.length&&"_r_Totals"!==a.text&&0<a.level){l[a.level-1].groupHeaders.push({titleText:a.label,numberOfColumns:0});c=l[a.level-1].groupHeaders.length-1;g=0===c?ka:ca+N;if(a.level-1===(m.rowTotals?1:0)&&
0<c){var h=l[a.level-1].groupHeaders[c-1].numberOfColumns;h&&(g=h+1+m.aggregates.length)}l[a.level-1].groupHeaders[c].startColumnName=e[g].name;l[a.level-1].groupHeaders[c].numberOfColumns=e.length-g;ca=e.length}U[a.level]=a.text}if(a.level===z&&"level"===d&&0<z)if(1<N){c=1;for(b in a.fields)1===c&&l[z-1].groupHeaders.push({startColumnName:b,numberOfColumns:1,titleText:a.text}),c++;l[z-1].groupHeaders[l[z-1].groupHeaders.length-1].numberOfColumns=c-1}else l.splice(z-1,1)}null!=a[d]&&"object"===typeof a[d]&&
p(a[d]);if("level"===d&&0<a.level)for(b in c=0,a.fields)if(a.fields.hasOwnProperty(b)){g={};for(f in m.aggregates[c])if(m.aggregates[c].hasOwnProperty(f))switch(f){case "member":case "label":case "aggregator":break;default:g[f]=m.aggregates[c][f]}1<N?(g.name=b,g.label=m.aggregates[c].label||a.label):(g.name=a.text,g.label="_r_Totals"===a.text?m.rowTotalsText:a.label);e.push(g);c++}}}var s,u,t,y=d.length,B,z,N,w,Q=0;m.rowTotals&&0<m.yDimension.length&&(m.yDimension.splice(0,0,{dataName:m.yDimension[0].dataName}),
m.yDimension[0].converter=function(){return"_r_Totals"});B=a.isArray(m.xDimension)?m.xDimension.length:0;z=m.yDimension.length;N=a.isArray(m.aggregates)?m.aggregates.length:0;if(0===B||0===N)throw"xDimension or aggregates optiona are not set!";var O;for(t=0;t<B;t++)O={name:m.xDimension[t].dataName,frozen:m.frozenStaticCols},null==m.xDimension[t].isGroupField&&(m.xDimension[t].isGroupField=!0),O=a.extend(!0,O,m.xDimension[t]),e.push(O);O=B-1;for(var X={};Q<y;){s=d[Q];var F=[],S=[];w={};t=0;do F[t]=
a.trim(s[m.xDimension[t].dataName]),w[m.xDimension[t].dataName]=F[t],t++;while(t<B);var v=0;u=-1;t=c(f,r,F);if(!t){v=0;if(1<=z){for(v=0;v<z;v++)S[v]=a.trim(s[m.yDimension[v].dataName]),m.yDimension[v].converter&&a.isFunction(m.yDimension[v].converter)&&(S[v]=m.yDimension[v].converter.call(this,S[v],F,S));w=q(s,m.aggregates,S,w)}else 0===z&&(w=q(s,m.aggregates,null,w));f.push(w)}else if(0<=u){v=0;if(1<=z){for(v=0;v<z;v++)S[v]=a.trim(s[m.yDimension[v].dataName]),m.yDimension[v].converter&&a.isFunction(m.yDimension[v].converter)&&
(S[v]=m.yDimension[v].converter.call(this,S[v],F,S));t=q(s,m.aggregates,S,t)}else 0===z&&(t=q(s,m.aggregates,null,t));f[u]=t}s=0;var F=w=null,L;for(L in b)if(b.hasOwnProperty(L)){if(0===s)X.children&&void 0!==X.children||(X={text:L,level:0,children:[],label:L}),w=X.children;else{F=null;for(t=0;t<w.length;t++)if(w[t].text===L){F=w[t];break}F?w=F.children:(w.push({children:[],text:L,level:s,fields:b[L],label:g[L]}),w=w[w.length-1].children)}s++}Q++}var U=[],ca=e.length,ka=ca;0<z&&(l[z-1]={useColSpanStyle:!1,
groupHeaders:[]});p(X);if(m.colTotals)for(Q=f.length;Q--;)for(t=B;t<e.length;t++)y=e[t].name,h[y]=h[y]?h[y]+parseFloat(f[Q][y]||0):parseFloat(f[Q][y]||0);if(0<O)for(t=0;t<O;t++)e[t].isGroupField&&(k.groupingView.groupField.push(e[t].name),k.groupingView.groupSummary.push(m.groupSummary),k.groupingView.groupSummaryPos.push(m.groupSummaryPos));else k.grouping=!1;k.sortname=e[O].name;k.groupingView.hideFirstGroupCol=!0});return{colModel:e,rows:f,groupOptions:k,groupHeaders:l,summary:h}},jqPivot:function(d,
