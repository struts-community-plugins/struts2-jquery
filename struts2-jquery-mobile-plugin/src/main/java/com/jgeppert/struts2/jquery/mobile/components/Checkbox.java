...
public class Checkbox extends org.apache.struts2.components.Checkbox implements ThemeableBean {
    ...
    @StrutsTagAttribute(description = "Set the Checkbox theme. e.g. a,b,c,d or e")
