...
public class ListItem extends Anchor {
    ...
    private static final String PARAM_DIVIDER = "divider";
    private static final String PARAM_ID = "id";
    private static final String ID_PREFIX_LIST_ITEM = "list_item_";

    protected String divider;

    public ListItem(ValueStack stack, HttpServletRequest request, HttpServletResponse response) {
    ...
    public void evaluateExtraParams() {
        ...
        if (this.divider != null) {
            addParameter(PARAM_DIVIDER, findValue(this.divider, Boolean.class));
        }
        ...
        if ((this.id == null || this.id.length() == 0)) {
            ...
            this.id = ID_PREFIX_LIST_ITEM + String.valueOf(nextInt);
