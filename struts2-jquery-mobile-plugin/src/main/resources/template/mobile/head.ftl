...
<#if parameters.compressed?default(true)>
  <#assign jqueryMobileFile="jquery.mobile-1.1.0.min.js">
  <#assign jqueryMobileCss="jquery.mobile-1.1.0.min.css">
  <#assign jqueryMobileStrutsFile="jquery.mobile.struts2-3.3.1.min.js">
<#else>
  <#assign jqueryMobileFile="jquery.mobile-1.1.0.js">
  <#assign jqueryMobileCss="jquery.mobile-1.1.0.css">
  <#assign jqueryMobileStrutsFile="jquery.mobile.struts2-3.3.1.js">
</#if>
