...
c.subscribeTopics(d,a.checkHideTopics,c.handler.hide_checkboxes,a);a.checkAllTopics&&c.subscribeTopics(d,a.checkAllTopics,c.handler.check_checkboxes,a);a.uncheckAllTopics&&c.subscribeTopics(d,a.uncheckAllTopics,c.handler.uncheck_checkboxes,a);a.url&&(a.core.data={},a.core.data.url=a.url,a.core.data.data=function(a){return{id:a.id}},a.onsuc&&(a.json_data.ajax.complete=function(k,e,f){b.each(a.onsuc.split(","),function(b,g){var h={};h.data=k;h.status=e;h.request=f;c.publishTopic(d,g,h);c.publishTopic(d,
a.onalw,h)})}),a.oncom&&(a.json_data.ajax.complete=function(k,e){b.each(a.oncom.split(","),function(b,l){var g={};g.request=k;g.status=e;c.publishTopic(d,l,g);c.publishTopic(d,a.onalw,g)})}),a.onerr&&(a.json_data.ajax.error=function(k,e,f){b.each(a.onerr.split(","),function(b,g){var h={};h.request=k;h.status=e;h.error=f;c.publishTopic(d,g,h);c.publishTopic(d,a.onalw,h)})}));d.on("select_node.jstree",function(k,e){var f={};f.data=e;f.event=k;a.onclick&&c.publishTopic(d,a.onclick,f);if(e.node.a_attr.href&&
"javascript:void(0)"!==e.node.a_attr.href&&"#"!==e.node.a_attr.href)window.open(e.node.a_attr.href,"_blank");else{var l=e.node.a_attr.id,g=b(c.escId(l)),f=g.data("targets");void 0===f&&(f=a.nodeTargets);f&&b.each(f.split(","),function(d,e){if(b(c.escId(e)).isSubscribed("_sj_action_"+l+e))g.publish("_sj_action_"+l+e);else{var f=a.nodeHref;a.nodeHrefParamName&&(f=c.addParam(f,a.nodeHrefParamName+"\x3d"+l));b(c.escId(e)).load(f)}return!1})}});a.openload&&d.bind("loaded.jstree",function(a,b){d.jstree("open_all")});
a.openrefresh&&d.bind("refresh.jstree",function(a,b){d.jstree("open_all")});a.animation&&(a.core={},a.core.animation=a.animation);d.jstree(a)},treeitem:function(b,a){this.anchor(b,a)}};b.subscribeHandler(b.struts2_jquery_tree.handler.show_checkboxes,function(d,a){b(this).jstree("show_checkboxes")});b.subscribeHandler(b.struts2_jquery_tree.handler.hide_checkboxes,function(d,a){b(this).jstree("hide_checkboxes")});b.subscribeHandler(b.struts2_jquery_tree.handler.toggle_checkboxes,function(d,a){b(this).jstree("toggle_checkboxes")});
b.subscribeHandler(b.struts2_jquery_tree.handler.check_checkboxes,function(d,a){b(this).jstree("check_all")});b.subscribeHandler(b.struts2_jquery_tree.handler.uncheck_checkboxes,function(d,a){b(this).jstree("uncheck_all")});b.extend(!0,b.struts2_jquery_tree,b.struts2_jquery);b.struts2_jquery_tree.debugPrefix="[struts2_jquery_tree] "})(jQuery);
//# sourceMappingURL=jquery.tree.struts2.min.js.map