...
public class ListView extends ActionSupport {
    ...
    @Actions({
	    @Action(value = "/list-view", results = { @Result(location = "list-view.jsp", name = "success") }),
	    @Action(value = "/list-view-counter", results = { @Result(location = "list-view-counter.jsp", name = "success") }) })
