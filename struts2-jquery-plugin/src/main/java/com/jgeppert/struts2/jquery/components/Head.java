...
public class Head extends org.apache.struts2.components.Head
{
	...
	private static final String[]	gridLocals		= {
			"bg", "ca", "cn", "cs", "de", "dk", "el", "en-GB", "en", "fa", "fi", "fr-CH", "fr", "he", "is", "it", "ja", "nl", "no", "pl", "pt-BR", "pt", "ro", "ru", "sk", "sp", "sv", "tr", "ua", "zh", "zh-CN"
													};
	private static final String[]	jqueryLocals	= {
			"af", "ar", "az", "bg", "bs", "ca", "cs", "da", "de", "el", "en", "en-GB", "eo", "es", "et", "eu", "fa", "fi", "fo", "fr-CH", "fr", "he", "hr", "hu", "hy", "id", "is", "it", "ja", "ko", "lt", "lv", "ms", "nl", "no", "pl", "pt", "pt-BR", "ro", "ru", "sk", "sl", "sq",
