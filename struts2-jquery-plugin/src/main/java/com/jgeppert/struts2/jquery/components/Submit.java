...
public class Submit extends AbstractRemoteBean implements ButtonBean {
	...
	addOgnlEvaluatedStringParameterIfExists("type", type);
	addOgnlEvaluatedStringParameterIfExists("src", src);
	...
	addOgnlEvaluatedStringParameterIfExists("formFilter", formFilter);
