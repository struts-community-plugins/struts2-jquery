...
public class DatePicker extends AbstractTopicsBean {
	...
	if (showButtonPanel != null)
	    addParameter("showButtonPanel", findValue(showButtonPanel,
		    Boolean.class));
	if (changeMonth != null)
	...
	if (buttonImageOnly != null)
	    addParameter("buttonImageOnly", findValue(buttonImageOnly,
		    Boolean.class));
	if (buttonText != null)
	...
	if (timepickerOnly != null)
	    addParameter("timepickerOnly", findValue(timepickerOnly,
		    Boolean.class));
	if (timepickerAmPm != null)
	    addParameter("timepickerAmPm", findValue(timepickerAmPm,
		    Boolean.class));
	if (timepickerShowHour != null)
	    addParameter("timepickerShowHour", findValue(timepickerShowHour,
		    Boolean.class));
	if (timepickerShowMinute != null)
	    addParameter("timepickerShowMinute", findValue(
		    timepickerShowMinute, Boolean.class));
	if (timepickerShowSecond != null)
	    addParameter("timepickerShowSecond", findValue(
		    timepickerShowSecond, Boolean.class));
	if (timepickerStepHour != null)
	    addParameter("timepickerStepHour", findValue(timepickerStepHour,
		    Number.class));
	if (timepickerStepMinute != null)
	    addParameter("timepickerStepMinute", findValue(timepickerStepMinute,
		    Number.class));
	if (timepickerStepSecond != null)
	    addParameter("timepickerStepSecond", findValue(timepickerStepSecond,
		    Number.class));
	...
	if (timepickerGridHour != null)
	    addParameter("timepickerGridHour", findValue(timepickerGridHour,
		    Number.class));
	if (timepickerGridMinute != null)
	    addParameter("timepickerGridMinute", findValue(timepickerGridMinute,
		    Number.class));
	if (timepickerGridSecond != null)
	    addParameter("timepickerGridSecond", findValue(timepickerGridSecond,
		    Number.class));
	...
	if (obj instanceof Date) {
	    ...
	    return MessageFormat.format(RFC3339_PATTERN, ((Calendar) obj)
		    .getTime());
	} else {
	    // try to parse a date
