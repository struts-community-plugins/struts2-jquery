 ...
 */
(function ($) {
    $.struts2_jquery_ui = {handler: {open_dialog: "_s2j_open_dialog", close_dialog: "_s2j_close_dialog", destroy_dialog: "_s2j_destroy_dialog"}, opendialog: function ($elem, o) {
        var self = this, dialog, openTopic = "_s2j_dialog_open_" + o.id;
        ...
        var self = this, daos = o.draggableoptions, dao = window[daos];
        ...
        var self = this, doos = o.droppableoptions, doo = window[doos];
        ...
        var self = this, seos = o.selectableoptions, seo = window[seos];
        ...
        var self = this, soos = o.sortableoptions, soo = window[soos];
        ...
        var self = this, ros = o.resizableoptions, ro = window[ros];
        if (!self.loadAtOnce) {
        ...
        o.open = function (event, ui) {
            var data = {}, divTopic = "_s2j_topic_load_" + o.id;
            data.event = event;
            data.ui = ui;
            if (o.href && o.href !== "#") {
        ...
        var self = this, ahp = {}, disabledtabsStr = o.disabledtabs, disabledtabs = window[disabledtabsStr], tabs = $elem.data("taboptions"), tabStr = "", closable = false, l, tab;
        ...
        o.ajaxOptions = {dataType: "html"};
        o.beforeLoad = function (event, ui) {
            var data = {}, form = "" + ui.tab.data("form"), links;
            data.event = event;
            data.ui = ui;
            if (form) {
        ...
        o.activate = function (event, ui) {
            var data = {}, form = $elem.data("tab" + ui.index), links;
            data.event = event;
            data.ui = ui;
            if (o.cookie) {
        ...
        var self = this, params = {}, oat = o.onalw, noms, nom, sos, so;
        ...
        var self = this, data = {}, active = true, aktivItem;
        ...
        o.beforeActivate = function (event, ui) {
            if (o.href) {
                if (typeof $(ui.newHeader).find("a").data("keys") !== "undefined") {
                    var keys = ("" + $(ui.newHeader).find("a").data("keys")).split(","), values = ("" + $(ui.newHeader).find("a").data("values")).split(","), valueparams = {};
        ...
        if (o.href && active === true) {
            ...
            if (typeof $(aktivItem).data("keys") !== "undefined") {
                var keys = ("" + $(aktivItem).data("keys")).split(","), values = ("" + $(aktivItem).data("values")).split(","), valueparams = {};
                $.each(keys, function (i, val) {
                    valueparams[val] = values[i]
                });
        ...
        if (url !== "") {
            if (o.list) {
                params.source = function (request, response) {
                    ...
                    self.currentXhr[o.id] = $.ajax({url: self.addForms(o.formids, url), dataType: "json", data: {term: request.term}, complete: function (request, status) {
                        self.hideIndicator(o.indicatorid)
                    }, success: function (data) {
                        self.currentXhr[o.id] = null;
                        var x = 0, isMap = false, result = [];
                        if (data[o.list] !== null) {
                            ...
                            $.each(data[o.list], function (j, val) {
                                if (isMap) {
                                    result.push({label: val.replace(new RegExp("(?![^&;]+;)(?!<[^<>]*)(" + $.ui.autocomplete.escapeRegex(request.term) + ")(?![^<>]*>)(?![^&;]+;)", "gi"), "<strong>$1</strong>"), value: val, key: j})
                                } else {
                                    if (o.listkey !== undefined && o.listvalue !== undefined) {
                                        ...
                                        if (o.listlabel) {
                                            ...
                                            label = val[o.listvalue].replace(new RegExp("(?![^&;]+;)(?!<[^<>]*)(" + $.ui.autocomplete.escapeRegex(request.term) + ")(?![^<>]*>)(?![^&;]+;)", "gi"), "<strong>$1</strong>")
                                        }
                                        result.push({label: label, value: val[o.listvalue], key: val[o.listkey]})
                                    } else {
                                        result.push({label: data[o.list][x].replace(new RegExp("(?![^&;]+;)(?!<[^<>]*)(" + $.ui.autocomplete.escapeRegex(request.term) + ")(?![^<>]*>)(?![^&;]+;)", "gi"), "<strong>$1</strong>"), value: data[o.list][x], key: data[o.list][x]})
                                    }
                                }
                                x++
                            });
        ...
        var self = this, buttonsetLoadTopic = "_s2j_topic_load_" + o.id, buttonsetTopic = "s2j_butonset_" + o.id;
        ...
        if (o.href && o.href !== "#") {
            ...
            $elem.subscribe(buttonsetTopic, function (event, data) {
                if (o.oncha) {
                    var selectString = self.escId(o.id) + " > input", elements = $(selectString);
    ...
    $.subscribeHandler($.struts2_jquery_ui.handler.open_dialog, function (event, data) {
        var s2j = $.struts2_jquery_ui, o = $(this).data("s2j_options");
        if (data) {
