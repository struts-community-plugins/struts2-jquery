...
*/
'use strict';(function(f,u){f.struts2_jquery={debug:!1,debugPrefix:"[struts2_jquery] ",ajaxhistory:!1,loadAtOnce:!1,local:"en",gridLocal:"en",timeLocal:"en",minSuffix:".min",historyelements:{},forms:{},scriptCache:{},styleCache:{},defaults:{indicator:"",loadingText:null,errorText:null},handler:{load:"_s2j_container_load",form:"_s2j_form_submit",effect:"_s2j_effects"},currentXhr:{},log:function(b){this.debug&&(b=this.debugPrefix+b,window.console&&window.console.log?window.console.log(b):window.opera&&
window.opera.postError&&window.opera.postError(b))},escId:function(b){return"#"+b.replace(/(:|\.)/g,"\\$1")},addParam:function(b,a){return 0<b.indexOf("?")?b+"\x26"+a:b+"?"+a},changeParam:function(b,a,d){b=b.split("?");var e=b[1].split("\x26"),c=[],g;for(g=0;g<e.length;g++)c=e[g].split("\x3d"),c[0]===a&&(e[g]=c[0]+"\x3d"+d);return b[0]+"?"+e.join("\x26")},require:function(b,a,d){var e=this,c,g;c=a||function(){};g=d||null;null!==g||f.scriptPath?null===g&&f.scriptPath&&(g=f.scriptPath):g="";"string"===
typeof b&&(b=b.split(","));f.each(b,function(a,b){b=e.addParam(b,"s2j\x3d"+f.struts2_jquery.version);f.struts2_jquery.scriptCache[b]||(e.log("load require script "+(g+b)),f.ajax({type:"GET",scriptCharset:"UTF-8",url:g+b,success:c,dataType:"script",cache:!0,async:!1}),f.struts2_jquery.scriptCache[b]=!0)})},requireCss:function(b,a){if(!this.styleCache[b]){var d,e;d=a||null;null!==d||f.scriptPath?null===d&&f.scriptPath&&(d=f.scriptPath):d="";this.log("load require css "+(d+b));e=document.createElement("link");
...
e.oneffect&&(f.each(e.targets.split(","),function(a,b){f.subscribe(f(d.escId(b)),e.oneffect,e)}),h=function(){f.each(e.targets.split(","),function(a,b){d.publishTopic(f(d.escId(b)),e.oneffect,e)})}),d.loadAtOnce||d.require(["js/base/effect"+d.minSuffix+".js","js/base/effect-"+e.effect+d.minSuffix+".js"]),d.log("effect "+e.effect+" for "+e.targets),f.each(e.targets.split(","),function(a,b){k=f(d.escId(b));e.effectmode&&"none"!==e.effectmode?"show"===e.effectmode?k.show(e.effect,c,g,h):"hide"===e.effectmode?
k.hide(e.effect,c,g,h):"toggle"===e.effectmode&&k.toggle(e.effect,c,g,h):k.effect(e.effect,c,g,h)}))})})(jQuery);