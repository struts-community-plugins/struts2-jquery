...
<#assign googleUiPath="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.17">
...
<#if parameters.compressed?default(true)>
  ...
  <#assign jqueryStrutsFile="jquery.struts2-3.2.1.min.js">
...
<#else>
  ...
  <#assign jqueryStrutsFile="jquery.struts2-3.2.1.js">
...
<#if parameters.loadFromGoogle?default(false)>
	...
	<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.17/i18n/jquery.ui.datepicker-${parameters.jqueryLocale?string}.min.js"></script>
		</#if>
	</#if>
<#else>
