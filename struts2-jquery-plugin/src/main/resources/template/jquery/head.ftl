...
<#if parameters.compressed?default(true)>
  ...
  <#assign jqueryUiGoogle="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.3/jquery-ui.min.js">
<#else>
  ...
  <#assign jqueryUiGoogle="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.3/jquery-ui.js">
</#if>
...
<#if parameters.jqueryui?default(true)>
    <#if parameters.jquerytheme?if_exists != "">
		<#if parameters.loadFromGoogle?default(false) && basePath == "${base}/struts/themes">
        	<link rel="stylesheet" href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.3/themes/${parameters.jquerytheme?string}/jquery-ui.css" type="text/css"/>
		<#else>
