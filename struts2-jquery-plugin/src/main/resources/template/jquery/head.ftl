...
<#if parameters.loadFromGoogle?default(false)>
	...
	<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.21/i18n/jquery.ui.datepicker-${parameters.jqueryLocale?string}.min.js"></script>
		</#if>
	</#if>
<#else>
