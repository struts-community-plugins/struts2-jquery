...
<div id="col3">
  <div id="col3_content" class="clearfix">
	...
	<div class="code ui-widget-content ui-corner-all">
	  <strong>Code:</strong>
	  <pre>
    &lt;sj:effectDiv <strong>resizable="true" resizableAnimate="true" resizableGhost="true" resizableHandles="all"</strong> cssClass="ui-widget-content ui-corner-all" cssStyle="width: 250px; height: 180px; padding: 0.5em;"&gt;
        Resize me!&lt;br/&gt;
        Resize me!&lt;br/&gt;
        Resize me!&lt;br/&gt;
    &lt;/sj:effectDiv&gt;
