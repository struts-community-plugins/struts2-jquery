...
public class Accordion extends ActionSupport {
	...
	@Actions({
	@Action(value="/accordion", 
			   results={@Result( location = "accordion.jsp", name="success")}
			),
	@Action(value="/accordion-mouseover", 
			   results={@Result( location = "accordion-mouseover.jsp", name="success")}
			)
	})
