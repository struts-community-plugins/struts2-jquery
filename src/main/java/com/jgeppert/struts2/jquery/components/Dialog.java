 ...
 * &lt;/script&gt;         
 * &lt;s:url id="remoteurl" action="myremoteaction"/&gt;
 * &lt;sj:dialog id="mydialog4" href="%{remoteurl}" title="Dialog with Buttons" buttons="'OK':function() {okButton();},'Cancel':function() {cancelButton();}"/&gt;
 * <!-- END SNIPPET: example4 -->
 * 
 * <!-- START SNIPPET: example5 -->
 * &lt;s:url id="remoteurl" action="myremoteaction"/&gt;
 * &lt;sj:dialog id="mydialog5" href="%{remoteurl}" title="Remote Dialog open on Click" autoOpen="false" modal="true"/&gt;
...
public class Dialog extends AbstractRemoteBean implements RemoteBean {
    ...
    public void evaluateExtraParams() {
        ...
        if (dialogClass != null)
          addParameter("dialogClass", findString(dialogClass));
        if (height != null)
          addParameter("height", findString(height));
        if (this.modal != null)
          addParameter("modal", findValue(this.modal, Boolean.class));
        if (position != null)
        ...
        if (showEffect != null)
          addParameter("showEffect", findString(showEffect));
        if (hideEffect != null)
          addParameter("hideEffect", findString(hideEffect));
        if (overlayColor != null)
          addParameter("overlayColor", findString(overlayColor));
        if (overlayOpacity != null)
          addParameter("overlayOpacity", findString(overlayOpacity));
    }
