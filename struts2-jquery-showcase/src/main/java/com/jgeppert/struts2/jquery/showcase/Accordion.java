...
public class Accordion extends ActionSupport
{
	...
	@Actions( {
			@Action(value = "/accordion-list", results = {
				@Result(location = "accordion-list.jsp", name = "success")
			}), @Action(value = "/accordion-mouseover", results = {
				@Result(location = "accordion-mouseover.jsp", name = "success")
			})
	})
